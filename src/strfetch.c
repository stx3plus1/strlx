...
int main(int argc, char **argv) {
	...
	if (!CONFIG) {
		//system("mkdir -p $HOME/.config/strfetch; touch $HOME/.config/strfetch/conf");
		//printf("%s", getenv("HOME"));
		//CONFIG = fopen(getenv("HOME"), "w");	
		//if (!CONFIG) {
			//debug
		...
		//i = 0;
		//while (i <= iconfig) {
		//	fprintf(CONFIG, "%s", config[i]);
		//	i++;
		//}
		//fclose(CONFIG);
		//printf("Autogenerated configuration file.\n");
		//return 0;
	} else {
